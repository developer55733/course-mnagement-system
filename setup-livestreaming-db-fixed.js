...
async function setupLivestreamingTables() {
    try {
        ...
        await query('CREATE INDEX IF NOT EXISTS idx_live_streams_status ON live_streams(status)');
        await query('CREATE INDEX IF NOT EXISTS idx_live_streams_created_by ON live_streams(created_by)');
        await query('CREATE INDEX IF NOT EXISTS idx_live_streams_created_at ON live_streams(created_at)');
        
        await query('CREATE INDEX IF NOT EXISTS idx_live_meetings_status ON live_meetings(status)');
        await query('CREATE INDEX IF NOT EXISTS idx_live_meetings_created_by ON live_meetings(created_by)');
        await query('CREATE INDEX IF NOT EXISTS idx_live_meetings_created_at ON live_meetings(created_at)');
        ...
        await query('CREATE INDEX IF NOT EXISTS idx_stream_participants_stream_id ON stream_participants(stream_id)');
        await query('CREATE INDEX IF NOT EXISTS idx_stream_participants_user_id ON stream_participants(user_id)');
        
        await query('CREATE INDEX IF NOT EXISTS idx_chat_messages_meeting_id ON chat_messages(meeting_id)');
        await query('CREATE INDEX IF NOT EXISTS idx_chat_messages_stream_id ON chat_messages(stream_id)');
        await query('CREATE INDEX IF NOT EXISTS idx_chat_messages_created_at ON chat_messages(created_at)');
        
        await query('CREATE INDEX IF NOT EXISTS idx_recording_sessions_meeting_id ON recording_sessions(meeting_id)');
        await query('CREATE INDEX IF NOT EXISTS idx_recording_sessions_stream_id ON recording_sessions(stream_id)');
        
        console.log('✅ Live streaming and meeting tables created successfully!');
        console.log('📊 Tables created:');
        console.log('  - live_streams');
        console.log('  - live_meetings');
        console.log('  - meeting_participants');
        console.log('  - stream_participants');
        console.log('  - chat_messages');
        console.log('  - recording_sessions');
