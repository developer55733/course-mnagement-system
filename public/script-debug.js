...
function initialize() { console.log('Initialize function called!');
  setupEventListeners();
  checkSession();
  loadInitialData();
  initDevAdminPage();
...
function setupEventListeners() { console.log('Setting up event listeners...');
  // Tab switching
  tabBtns.forEach(btn => {
...
// Auth Functions
async function handleLogin(e) { console.log('Login function called!');
  e.preventDefault();
...
async function handleRegister(e) { console.log('Register function called!');
  e.preventDefault();
...
console.log('Script loaded'); document.addEventListener('DOMContentLoaded', function() { console.log('DOM loaded'); initialize(); });
